...
//     { from: "bot", text: "👋 Hello! I'm your FinSmart Assistant. How can I help you today?" }
//   ]);
...
//       });
//       const { reply, session_id, chips } = res.data;
...
//       <div className="chatbot-header">💼 FinSmart Banking Assistant</div>

//       <div className="chatbot-body">
//         {messages.map((msg, idx) => (
//           <motion.div key={idx} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className={`chat-message ${msg.from}`}>
//             {msg.text}
//             {msg.chips?.length > 0 && (
//               <div className="chips">
//                 {msg.chips.map((chip, i) => (
//                   <button key={i} onClick={() => handleChipClick(chip)}>{chip}</button>
//                 ))}
//               </div>
//             )}
//           </motion.div>
//         ))}
//         {loading && (
//           <motion.div className="chat-message bot typing" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
...
//       {/* ✅ Feedback button */}
//       <div className="feedback-section" style={{ textAlign: "center", marginTop: "1rem" }}>
//         <button
...
//     {
//       from: "bot",
//       text: "👋 Hello! I'm your FinSmart Assistant. How can I help you today?",
//     },
//   ]);
//   const [input, setInput] = useState("");
//   const [loading, setLoading] = useState(false);
...
//           reply =
//             "👨‍💼 Rahul: I can help you with account creation or status updates. Could you please specify your request?";
...
//         setMessages((prev) => [...prev, { from: "human", text: reply }]);
//         setLoading(false);
//       }, 1000);
//       return;
//     }
...
//       // 🔹 If chatbot can’t answer — offer human support
//       // if (intent === "fallback") {
//       //   setMessages((prev) => [
//       //     ...prev,
//       //     {
//       //       from: "bot",
//       //       text:
//       //         "🤖 Sorry, I couldn't find the right answer. Would you like to connect with a human agent for personalized help?",
...
//           from: "bot",
//           text:
//             "⚠️ Oops! Something went wrong. Please try again after a moment.",
//         },
//       ]);
//     } finally {
//       setLoading(false);
...
//   // 💬 Chip button click logic
//   const handleChipClick = (chip) => {
//   // 🔹 When user clicks "Connect to Human Agent"
//   if (chip === "Connect to Human Agent") {
//     setHumanMode(true);
//     setMessages((prev) => [
//       ...prev,
...
//   // 🔹 When user clicks "Return to AI Assistant"
//   if (chip === "Return to AI Assistant") {
//     setHumanMode(false);
//     setMessages((prev) => [
//       ...prev,
...
//     <button onClick={() => handleChipClick("Return to AI Assistant")}>
...
//     // 🔹 If user chooses "Talk to Agent" — trigger human mode
//     if (intent === "talk_to_agent" || intent === "human_handoff") {
//       setHumanMode(true);
